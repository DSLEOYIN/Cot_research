...
export function McpsPage({ mcps, skills, onNavigate, onCreate, onHealthCheck }: Props) {
  ...
  return <section className="management-page">
    <PageHeader eyebrow="Tool Ops" title="MCP 管理" description="管理工具连接、输入 Schema、依赖阻塞和发布准备状态。" actions={<><button className="secondary-action" type="button" onClick={onHealthCheck}>↻ 全部健康检查</button><button className="primary-action" type="button" onClick={onCreate}>＋ 接入 MCP</button></>} />
